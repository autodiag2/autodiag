...
JNIEXPORT void JNICALL Java_com_github_autodiag2_elm327emu_libautodiag_setIgnitionState(JNIEnv *env,jobject thiz,jint state);
JNIEXPORT jint JNICALL Java_com_github_autodiag2_elm327emu_libautodiag_getIgnitionState(JNIEnv *env, jobject thiz);
#endif
