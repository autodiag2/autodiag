...
// ISO 14229-1
typedef enum {
    AD_UDS_SERVICE_DIAGNOSTIC_SESSION_CONTROL = 0x10,
    AD_UDS_SERVICE_ECU_RESET = 0x11,
    AD_UDS_SERVICE_CLEAR_DIAGNOSTIC_INFORMATION = 0x14,
    AD_UDS_SERVICE_READ_DTC_INFORMATION = 0x19,
    AD_UDS_SERVICE_READ_DATA_BY_IDENTIFIER = 0x22,
    AD_UDS_SERVICE_READ_MEMORY_BY_ADDRESS = 0x23,
    AD_UDS_SERVICE_READ_SCALING_DATA_BY_IDENTIFIER = 0x24,
    AD_UDS_SERVICE_SECURITY_ACCESS = 0x27,
    AD_UDS_SERVICE_COMMUNICATION_CONTROL = 0x28,
    AD_UDS_SERVICE_AUTHENTICATION = 0x29,
    AD_UDS_SERVICE_READ_DATA_BY_PERIOD_IDENTIFIER = 0x2A,
    AD_UDS_SERVICE_DYNAMICALLY_DEFINE_DATA_IDENTIFIER = 0x2C,
    AD_UDS_SERVICE_WRITE_DATA_BY_IDENTIFIER = 0x2E,
    AD_UDS_SERVICE_INPUT_OUTPUT_CONTROL_BY_IDENTIFIER = 0x2F,
    AD_UDS_SERVICE_ROUTINE_CONTROL = 0x31,
    AD_UDS_SERVICE_REQUEST_DOWNLOAD = 0x34,
    AD_UDS_SERVICE_REQUEST_UPLOAD = 0x35,
    AD_UDS_SERVICE_TRANSFER_DATA = 0x36,
    AD_UDS_SERVICE_REQUEST_TRANSFER_EXIT = 0x37,
    AD_UDS_SERVICE_REQUEST_FILE_TRANSFER = 0x38,
    AD_UDS_SERVICE_WRITE_MEMORY_BY_ADDRESS = 0x3D,
    AD_UDS_SERVICE_TESTER_PRESENT = 0x3E,
    AD_UDS_SERVICE_ACCESS_TIMING_PARAMETERS = 0x83,
    AD_UDS_SERVICE_SECURED_DATA_TRANSMISSION = 0x84,
...
// WWH-OBD DID
typedef enum {
    AD_UDS_SERVICE_READ_DATA_BY_IDENTIFIER_WWH_OBD_DID_VIN = 0xF802
} AD_UDS_SERVICE_READ_DATA_BY_IDENTIFIER_WWH_OBD_DID;
