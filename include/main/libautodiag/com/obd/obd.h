 ...
 */
typedef enum {
    OBD_SERVICE_NONE = 0x00,
    OBD_SERVICE_SHOW_CURRENT_DATA = 0x01,
    OBD_SERVICE_SHOW_FREEEZE_FRAME_DATA = 0x02,
    OBD_SERVICE_SHOW_DTC = 0x03,
    OBD_SERVICE_CLEAR_DTC = 0x04,
    OBD_SERVICE_TESTS_RESULTS = 0x05,
    OBD_SERVICE_TESTS_RESULTS_OTHER = 0x06,
    OBD_SERVICE_PENDING_DTC = 0x07,
    OBD_SERVICE_CONTROL_OPERATION = 0x08,
    OBD_SERVICE_REQUEST_VEHICLE_INFORMATION = 0x09,
    OBD_SERVICE_PERMANENT_DTC = 0x0A
} OBDServiceId;

typedef enum {
    OBD_SERVICE_REQUEST_VEHICLE_INFORMATION_E_VIN = 0x02,
    OBD_SERVICE_REQUEST_VEHICLE_INFORMATION_E_ECU_NAME = 0x0A
} OBD_SERVICE_REQUEST_VEHICLE_INFORMATION_E;
