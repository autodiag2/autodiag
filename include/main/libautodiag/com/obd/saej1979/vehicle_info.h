...
#define SAEJ1979_VEHICLE_INFO_GENERATE_OBD_REQUEST_ITERATE_BODY(type,sym,errorValue,pid,iterator) type sym(final VehicleIFace* iface) { \
...
void* saej1979_vehicle_info_discover_ecus_name(final VehicleIFace* iface);
void* saej1979_vehicle_info_discover_vin(final VehicleIFace* iface);
