...
typedef struct SimECUGenerator {
    void *context;
    char *type;
    bool (*response)(struct SimECUGenerator * this, char ** response, final Buffer *binResponse, final Buffer *binRequest);
} SimECUGenerator;
...
#define SIM_ECU_GENERATOR_RESPONSE_FUNC(f) ((bool (*)(SimECUGenerator *, char **, Buffer *, Buffer *))f)
