...
void ad_saej1979_data_register_signals() {
    AD_SIGNAL_SAEJ1979_REGISTER("Number Of DTC",                            "${0}01${1}", 0,        127,        "$2 & 0x7F",                                 "Get number of DTCs currently flagged in ECU",                   "Engine, ECM",              "number_of_dtc",                                       "count")
    AD_SIGNAL_SAEJ1979_REGISTER("MIL Status",                               "${0}01${1}", 0,        1,          "($2 >> 7) & 1",                             "Get status of MIL/CEL",                                         "Engine, ECM",              "mil_status",                                          "bool")
    AD_SIGNAL_SAEJ1979_REGISTER("Type of engine",                           "${0}01${1}", 0,        1,          "($3 >> 3) & 1",                             "Get the type of engine (0: spark, 1: compression)",             "Engine, ECM",              "engine_spark_or_compression",                         "bool")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine Load",                              "${0}04${1}", 0,        100,        "$2 / 2.55",                                 "Calculated engine load",                                        "Engine, ECM",              "engine_load",                                         "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Coolant Temperature",                      "${0}05${1}", -40,      215,        "$2 - 40",                                   "Engine Coolant Temperature",                                    "Engine, ECM",              "coolant_temp",                                        "°C")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel Trim Short Term bank 1",              "${0}06${1}", -100,     99.2,       "$2 / 1.28 - 100",                           "Fuel Trim Short Term bank 1",                                   "Engine, ECM",              "fuel_trim_short_term_bank_1",                         "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel Trim Long Term bank 1",               "${0}07${1}", -100,     99.2,       "$2 / 1.28 - 100",                           "Fuel Trim Long Term bank 1",                                    "Engine, ECM",              "fuel_trim_long_term_bank_1",                          "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel Trim Short Term bank 2",              "${0}08${1}", -100,     99.2,       "$2 / 1.28 - 100",                           "Fuel Trim Short Term bank 2",                                   "Engine, ECM",              "fuel_trim_short_term_bank_2",                         "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel Trim Long Term bank 2",               "${0}09${1}", -100,     99.2,       "$2 / 1.28 - 100",                           "Fuel Trim Long Term bank 2",                                    "Engine, ECM",              "fuel_trim_long_term_bank_2",                          "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel Pressure",                            "${0}0A${1}", 0,        765,        "$2 * 3",                                    "Fuel Pressure",                                                 "Engine, ECM",              "fuel_pressure",                                       "kPa")
    AD_SIGNAL_SAEJ1979_REGISTER("Intake Manifold Pressure",                 "${0}0B${1}", 0,        255,        "$2",                                        "Intake manifold pressure",                                      "Engine, ECM",              "intake_manifold_pressure",                            "kPa")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine Speed",                             "${0}0C${1}", 0,        16383.75,   "($2 * 256 + $3) / 4.0",                     "Rotational speed of engine",                                    "Engine, ECM",              "engine_speed",                                        "rpm")
    AD_SIGNAL_SAEJ1979_REGISTER("Vehicle Speed",                            "${0}0D${1}", 0,        255,        "$2",                                        "Vehicle Speed",                                                 "Engine, ECM",              "vehicle_speed",                                       "km/h")
    AD_SIGNAL_SAEJ1979_REGISTER("Timing Advance Cycle 1",                   "${0}0E${1}", -64,      63.5,       "($2 / 2.0) - 64",                           "Timing Advance (Cyl. #1)",                                      "Engine, ECM",              "timing_advance_cycle_1",                              "°")
    AD_SIGNAL_SAEJ1979_REGISTER("Intake Air Temperature",                   "${0}0F${1}", -40,      215,        "$2 - 40",                                   "Intake air temperature",                                        "Engine, ECM",              "intake_air_temperature",                              "°C")
    AD_SIGNAL_SAEJ1979_REGISTER("MAF Air Flow Rate",                        "${0}10${1}", 0,        655.35,     "($2 * 256 + $3) / 100.0",                   "MAF air flow rate",                                             "Engine, ECM",              "maf_air_flow_rate",                                   "g/s")
    AD_SIGNAL_SAEJ1979_REGISTER("Throttle Position",                        "${0}11${1}", 0,        100,        "$2 / 2.55",                                 "Throttle position",                                             "Engine, ECM",              "throttle_position",                                   "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Power Takeoff Status",                     "${0}1E${1}", 0,        1,          "$2 & 1",                                    "Power takeoff status",                                          "Engine, ECM",              "powertakeoff_status",                                 "bool")
    AD_SIGNAL_SAEJ1979_REGISTER("Seconds Since Engine Start",               "${0}1F${1}", 0,        65535,      "$2 * 256 + $3",                             "Seconds since engine start",                                    "Engine, ECM",              "seconds_since_engine_start",                          "s")
    AD_SIGNAL_SAEJ1979_REGISTER("Distance Since MIL Activated",             "${0}21${1}", 0,        65535,      "$2 * 256 + $3",                             "Distance since MIL activated",                                  "Engine, ECM",              "distance_since_mil_activated",                        "km")
    AD_SIGNAL_SAEJ1979_REGISTER("FRP Relative",                             "${0}22${1}", 0,        5177.265,   "($2 * 256 + $3) * 0.079",                   "Fuel rail pressure relative to manifold vacuum",                "Engine, ECM",              "frp_relative",                                        "kPa")
    AD_SIGNAL_SAEJ1979_REGISTER("FRP Wide Range",                           "${0}23${1}", 0,        655350,     "($2 * 256 + $3) * 10",                      "Fuel rail pressure wide range",                                 "Engine, ECM",              "frp_widerange",                                       "kPa")
    AD_SIGNAL_SAEJ1979_REGISTER("Commanded EGR",                            "${0}2C${1}", 0,        100,        "$2 / 2.55",                                 "Commanded EGR",                                                 "Engine, ECM",              "commanded_egr",                                       "%")
    AD_SIGNAL_SAEJ1979_REGISTER("EGR Error",                                "${0}2D${1}", -100,     99.2,       "$2 * (100.0 / 128) - 100",                  "EGR error",                                                     "Engine, ECM",              "egr_error",                                           "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Commanded EVAP Purge",                     "${0}2E${1}", 0,        100,        "$2 / 2.55",                                 "Commanded EVAP purge",                                          "Engine, ECM",              "commanded_evap_purge",                                "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel Tank Level Input",                    "${0}2F${1}", 0,        100,        "$2 / 2.55",                                 "Fuel tank level input",                                         "Engine, ECM",              "fuel_tank_level_input",                               "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Warm Ups Since ECU Reset",                 "${0}30${1}", 0,        255,        "$2",                                        "Warm ups since ECU reset",                                      "Engine, ECM",              "warm_ups_since_ecu_reset",                            "count")
    AD_SIGNAL_SAEJ1979_REGISTER("Distance Since ECU Reset",                 "${0}31${1}", 0,        65535,      "$2 * 256 + $3",                             "Distance since ECU reset",                                      "Engine, ECM",              "distance_since_ecu_reset",                            "km")
    AD_SIGNAL_SAEJ1979_REGISTER("EVAP System Vapor Pressure",               "${0}32${1}", 0,        16383.75,   "($2 * 256 + $3) * 0.25",                    "EVAP system vapor pressure",                                    "Engine, ECM",              "evap_system_vapor_pressure",                          "Pa")
    AD_SIGNAL_SAEJ1979_REGISTER("Barometric Pressure Absolute",             "${0}33${1}", 0,        255,        "$2",                                        "Absolute barometric pressure",                                  "Engine, ECM",              "baro_pressure_absolute",                              "kPa")
    AD_SIGNAL_SAEJ1979_REGISTER("ECU Voltage",                              "${0}42${1}", 0,        65.535,     "($2 * 256 + $3) * 0.001",                   "Control module voltage",                                        "Engine, ECM",              "ecu_voltage",                                         "V")
    AD_SIGNAL_SAEJ1979_REGISTER("Absolute Engine Load",                     "${0}43${1}", 0,        25700,      "($2 * 256 + $3) / 2.55",                    "Absolute engine load",                                          "Engine, ECM",              "absolute_engine_load",                                "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Commanded Air Fuel Equivalence Ratio",     "${0}44${1}", 0,        2,          "($2 * 256 + $3) * (2.0 / 65536)",           "Commanded air fuel equivalence ratio",                          "Engine, ECM",              "commanded_air_fuel_equivalence_ratio",                "ratio")
    AD_SIGNAL_SAEJ1979_REGISTER("Relative Throttle Position",               "${0}45${1}", 0,        100,        "$2 / 2.55",                                 "Relative throttle position",                                    "Engine, ECM",              "relative_throttle_position",                          "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Ambient Air Temperature",                  "${0}46${1}", -40,      215,        "$2 - 40",                                   "Ambient air temperature",                                       "Engine, ECM",              "ambient_air_temperature",                             "°C")
    AD_SIGNAL_SAEJ1979_REGISTER("Max Fuel Air Equiv Ratio",                 "${0}4F${1}", 0,        255,        "$2",                                        "Maximum fuel air equivalence ratio",                            "Engine, ECM",              "max_fuel_air_equiv_ratio",                            "raw")
    AD_SIGNAL_SAEJ1979_REGISTER("Max Oxygen Sensor Voltage",                "${0}4F${1}", 0,        255,        "$3",                                        "Maximum oxygen sensor voltage",                                 "Engine, ECM",              "max_oxygen_sensor_voltage",                           "raw")
    AD_SIGNAL_SAEJ1979_REGISTER("Max Oxygen Sensor Current",                "${0}4F${1}", 0,        255,        "$4",                                        "Maximum oxygen sensor current",                                 "Engine, ECM",              "max_oxygen_sensor_current",                           "raw")
    AD_SIGNAL_SAEJ1979_REGISTER("Max Intake Manifold Absolute Pressure",    "${0}4F${1}", 0,        2550,       "$5 * 10",                                   "Maximum intake manifold absolute pressure",                     "Engine, ECM",              "max_intake_manifold_absolute_pressure",               "kPa")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel ethanol percent",                     "${0}52${1}", 0,        100,        "$2 / 2.55",                                 "Fuel ethanol percent",                                          "Engine, ECM",              "fuel_ethanol_percent",                                "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Absolute EVAP System Vapor Pressure",      "${0}53${1}", 0,        327.675,    "($2 * 256 + $3) / 200.0",                   "Absolute EVAP system vapor pressure",                           "Engine, ECM",              "absolute_evap_system_vapor_pressure",                 "kPa")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel rail absolute pressure",              "${0}59${1}", 0,        655350,     "($2 * 256 + $3) * 10",                      "Get the fuel rail absolute pressure",                           "Engine, ECM",              "fuel_rail_absolute_pressure",                         "kPa")
    AD_SIGNAL_SAEJ1979_REGISTER("Relative accelerator pedal position",      "${0}5A${1}", 0,        100,        "$2 / 2.55",                                 "Get the relative accelerator pedal position",                   "Engine, ECM",              "relative_accelerator_pedal_position",                 "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Hybrid battery pack remaining life",       "${0}5B${1}", 0,        100,        "$2 / 2.55",                                 "Get the hybrid battery pack remaining life",                    "Engine, ECM",              "hybrid_battery_pack_remaining_life",                  "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel injection timing",                    "${0}5D${1}", -210,     301.992,    "(($2 * 256) + $3) / 128.0 - 210",           "Get the fuel injection timing",                                 "Engine, ECM",              "fuel_injection_timing",                               "°")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine fuel rate",                         "${0}5E${1}", 0,        3212.75,    "(($2 * 256) + $3) / 20.0",                  "Get the engine fuel rate",                                      "Engine, ECM",              "engine_fuel_rate",                                    "L/h")
    AD_SIGNAL_SAEJ1979_REGISTER("Emission requirements to which vehicle is designed", "${0}5F${1}", 0, 255, "$2", "Get the emission requirements to which vehicle is designed",                                               "Engine, ECM",              "emission_requirements_vehicle_designed",              "not found")
    AD_SIGNAL_SAEJ1979_REGISTER("Driver demand engine percent torque",      "${0}61${1}", -125,     130,        "$2 - 125",                                  "Get the driver demand engine percent torque",                   "Engine, ECM",              "driver_demand_engine_percent_torque",                 "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Actual engine percent torque",             "${0}62${1}", -125,     130,        "$2 - 125",                                  "Get the actual engine percent torque",                          "Engine, ECM",              "actual_engine_percent_torque",                        "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine reference torque",                  "${0}63${1}", 0,        65535,      "($2 * 256) + $3",                           "Get the engine reference torque",                               "Engine, ECM",              "engine_reference_torque",                             "N.m")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine percent torque data idle",          "${0}64${1}", -125,     130,        "$2 - 125",                                  "Get the engine percent torque data idle",                       "Engine, ECM",              "engine_percent_torque_data_idle",                     "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine percent torque data point 1",       "${0}64${1}", -125,     130,        "$3 - 125",                                  "Get the engine percent torque data point 1",                    "Engine, ECM",              "engine_percent_torque_data_point_1",                  "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine percent torque data point 2",       "${0}64${1}", -125,     130,        "$4 - 125",                                  "Get the engine percent torque data point 2",                    "Engine, ECM",              "engine_percent_torque_data_point_2",                  "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine percent torque data point 3",       "${0}64${1}", -125,     130,        "$5 - 125",                                  "Get the engine percent torque data point 3",                    "Engine, ECM",              "engine_percent_torque_data_point_3",                  "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine percent torque data point 4",       "${0}64${1}", -125,     130,        "$6 - 125",                                  "Get the engine percent torque data point 4",                    "Engine, ECM",              "engine_percent_torque_data_point_4",                  "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine Oil Temperature",                   "${0}5C${1}", -40,      210,        "$2 - 40",                                   "Engine oil temperature",                                        "Engine, ECM",              "engine_oil_temperature",                              "°C")
    AD_SIGNAL_SAEJ1979_REGISTER("Engine Friction Percent Torque",           "${0}8E${1}", -125,     130,        "$2 - 125",                                  "Engine friction percent torque",                                "Engine, ECM",              "engine_friction_percent_torque",                      "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Cylinder Fuel Rate",                       "${0}A2${1}", 0,        2047.96875, "($2 * 256 + $3) / 32.0",                    "Cylinder fuel rate",                                            "Engine, ECM",              "cylinder_fuel_rate",                                  "mg/stroke")
    AD_SIGNAL_SAEJ1979_REGISTER("Odometer",                                 "${0}A6${1}", 0,        429296729.5,"($2 * 16777216 + $3 * 65536 + $4 * 256 + $5) / 10.0", "Odometer",                                            "Engine, ECM",              "odometer",                                            "km")
    AD_SIGNAL_SAEJ1979_REGISTER("ABS Switch Present",                       "${0}A9${1}", 0,        1,          "$2 & 1",                                    "ABS switch present",                                            "ABS, ECM",                 "abs_switch_present",                                  "bool")
    AD_SIGNAL_SAEJ1979_REGISTER("ABS Switch",                               "${0}A9${1}", 0,        1,          "$3 & 1",                                    "ABS switch",                                                    "ABS, ECM",                 "abs_switch",                                          "bool")
}
/**
