...
char* saej1979_data_data_gen_pid_map_get(void *key) {
    if ( _saej1979_data_data_gen_pid_map == null ) {
        ...
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_number_of_dtc), object_string_new_from("01"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_type), object_string_new_from("01"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_mil_status), object_string_new_from("01"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_status), object_string_new_from("01"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_status_this_cycle), object_string_new_from("41"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_fuel_system_status), object_string_new_from("03"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_load), object_string_new_from("04"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_coolant_temperature), object_string_new_from("05"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_fuel_pressure), object_string_new_from("0A"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_intake_manifold_pressure), object_string_new_from("0B"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_speed), object_string_new_from("0C"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_vehicle_speed), object_string_new_from("0D"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_timing_advance_cycle_1), object_string_new_from("0E"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_intake_air_temperature), object_string_new_from("0F"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_maf_air_flow_rate), object_string_new_from("10"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_throttle_position), object_string_new_from("11"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_secondary_air_status), object_string_new_from("12"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_oxygen_sensors_present_generic), object_string_new_from("13"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_obd_standard), object_string_new_from("1C"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_oxygen_sensors_present_2_generic), object_string_new_from("1D"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_powertakeoff_status), object_string_new_from("1E"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_seconds_since_engine_start), object_string_new_from("1F"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_distance_since_mil_activated), object_string_new_from("21"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_frp_relative), object_string_new_from("22"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_frp_widerange), object_string_new_from("23"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_commanded_egr), object_string_new_from("2C"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_egr_error), object_string_new_from("2D"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_commanded_evap_purge), object_string_new_from("2E"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_fuel_tank_level_input), object_string_new_from("2F"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_warm_ups_since_ecu_reset), object_string_new_from("30"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_distance_since_ecu_reset), object_string_new_from("31"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_evap_system_vapor_pressure), object_string_new_from("32"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_baro_pressure_absolute), object_string_new_from("33"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_ecu_voltage), object_string_new_from("42"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_absolute_engine_load), object_string_new_from("43"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_commanded_air_fuel_equivalence_ratio), object_string_new_from("44"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_relative_throttle_position), object_string_new_from("45"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_ambient_air_temperature), object_string_new_from("46"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_time_run_mil_on), object_string_new_from("4D"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_time_since_trouble_codes_cleared), object_string_new_from("4E"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_max_fuel_air_equiv_ratio), object_string_new_from("4F"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_max_oxygen_sensor_voltage), object_string_new_from("4F"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_max_oxygen_sensor_current), object_string_new_from("4F"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_max_intake_manifold_absolute_pressure), object_string_new_from("4F"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_max_air_flow_rate_from_maf_sensor), object_string_new_from("50"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_fuel_type), object_string_new_from("51"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_absolute_evap_system_vapor_pressure), object_string_new_from("53"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_relative_evap_system_vapor_pressure), object_string_new_from("54"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_short_term_secondary_oxygen_sensor_trim_1), object_string_new_from("55"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_short_term_secondary_oxygen_sensor_trim_2), object_string_new_from("57"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_short_term_secondary_oxygen_sensor_trim_3), object_string_new_from("55"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_short_term_secondary_oxygen_sensor_trim_4), object_string_new_from("57"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_long_term_secondary_oxygen_sensor_trim_1), object_string_new_from("56"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_long_term_secondary_oxygen_sensor_trim_2), object_string_new_from("58"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_long_term_secondary_oxygen_sensor_trim_3), object_string_new_from("56"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_long_term_secondary_oxygen_sensor_trim_4), object_string_new_from("58"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_fuel_rail_absolute_pressure), object_string_new_from("59"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_oil_temperature), object_string_new_from("5C"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_fuel_injection_timing), object_string_new_from("5D"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_fuel_rate), object_string_new_from("5E"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_driver_demand_engine_percent_torque), object_string_new_from("61"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_actual_engine_percent_torque), object_string_new_from("62"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_reference_torque), object_string_new_from("63"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_percent_torque_data_idle), object_string_new_from("64"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_maf_sensor_present_1), object_string_new_from("66"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_maf_sensor_present_2), object_string_new_from("66"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_maf_sensor_1), object_string_new_from("66"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_maf_sensor_2), object_string_new_from("66"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_coolant_temperature_sensor_present_1), object_string_new_from("67"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_coolant_temperature_sensor_present_2), object_string_new_from("67"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_coolant_temperature_sensor_1), object_string_new_from("67"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_coolant_temperature_sensor_2), object_string_new_from("67"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_intake_air_temperature_sensor_present_1), object_string_new_from("68"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_intake_air_temperature_sensor_present_2), object_string_new_from("68"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_intake_air_temperature_sensor_1), object_string_new_from("68"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_intake_air_temperature_sensor_2), object_string_new_from("68"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_egt_sensor_bank_1_present_byte), object_string_new_from("78"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_egt_sensor_bank_2_present_byte), object_string_new_from("79"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_egt_sensor_temperature_bank_1), object_string_new_from("78"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_egt_sensor_temperature_bank_2), object_string_new_from("79"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_diesel_particulate_filter_temperature), object_string_new_from("7C"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_engine_friction_percent_torque), object_string_new_from("8E"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_cylinder_fuel_rate), object_string_new_from("A2"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_transmission_actual_gear_present), object_string_new_from("A4"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_transmission_actual_gear), object_string_new_from("A4"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_commanded_diesel_exhaust_fluid_dosing_present), object_string_new_from("A5"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_commanded_diesel_exhaust_fluid_dosing), object_string_new_from("A5"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_odometer), object_string_new_from("A6"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_abs_switch_present), object_string_new_from("A9"));
        object_hashmap_Ptr_string_set(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(saej1979_data_abs_switch), object_string_new_from("A9"));
    }
    object_string * string = object_hashmap_Ptr_string_get(_saej1979_data_data_gen_pid_map, object_Ptr_new_from(key));
    if ( string == null ) {
        return null;
    } else {
