...
void ad_saej1979_data_register_signals() {
    ...
    AD_SIGNAL_SAEJ1979_REGISTER("Commanded EGR",                            "${0}${1}2C", 0,        100,        "$2 / 2.55",                                 "Commanded EGR",                                                 "Engine, ECM",              "commanded_egr",                                       "%")
    AD_SIGNAL_SAEJ1979_REGISTER("EGR Error",                                "${0}${1}2D", -100,     99.2,       "$2 * (100.0 / 128) - 100",                  "EGR error",                                                     "Engine, ECM",              "egr_error",                                           "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Commanded EVAP Purge",                     "${0}${1}2E", 0,        100,        "$2 / 2.55",                                 "Commanded EVAP purge",                                          "Engine, ECM",              "commanded_evap_purge",                                "%")
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel Tank Level Input",                    "${0}${1}2F", 0,        100,        "$2 / 2.55",                                 "Fuel tank level input",                                         "Engine, ECM",              "fuel_tank_level_input",                               "%")
    ...
    AD_SIGNAL_SAEJ1979_REGISTER("Absolute Engine Load",                     "${0}${1}43", 0,        25700,      "($2 * 256 + $3) / 2.55",                    "Absolute engine load",                                          "Engine, ECM",              "absolute_engine_load",                                "%")
    ...
    AD_SIGNAL_SAEJ1979_REGISTER("Relative Throttle Position",               "${0}${1}45", 0,        100,        "$2 / 2.55",                                 "Relative throttle position",                                    "Engine, ECM",              "relative_throttle_position",                          "%")
    ...
    AD_SIGNAL_SAEJ1979_REGISTER("Fuel ethanol percent",                     "${0}${1}52", 0,        100,        "$2 / 2.55",                                 "Fuel ethanol percent",                                          "Engine, ECM",              "fuel_ethanol_percent",                                "%")
