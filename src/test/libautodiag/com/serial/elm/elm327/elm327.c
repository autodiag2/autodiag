...
bool testELM327(VehicleIFace* iface) {
    {
        ...
        for(int i = 0; i < 2; i ++) {
            ...
            ad_buffer_append_str(buffer,"7E80743010300000000");
    ...
    }
    {
        ...
        ELM327Device* elm = (ELM327Device*)tmp->device;
        Buffer * buffer = ad_buffer_new();
        ad_buffer_append_str(buffer,"7E9024300\r7E8024300\r");
        Buffer * bin = elm_ascii_to_bin((ELMDevice*)elm,buffer);
        elm->recv_buffer = buffer;
    ...
    }
    {
        ...
        Buffer * buffer = ad_buffer_new();
        ad_buffer_append_str(buffer,"7E9024300\r7E8100E430613361340\r7E82113380087133713\r7E82239AAAAAAAAAAAA\r");
        ...
        for(unsigned i = 0; i < tmp->vehicle->ecus_len; i++) {
            ...
            for(unsigned j = 0; j < ecu->data_buffer->size; j++) {
                ...
                if ( 14 == data->size ) {
                    found = true;
                    assert(ad_buffer_equals(ad_buffer_from_ascii_hex("4306133613401338008713371339"),data));
                }
            }
        }
        assert(found);
    ...
    }
    {
        ...
        ELM327Device* elm327 = (ELM327Device*)tmp->device;
        Buffer * buffer = ad_buffer_new();
        ad_buffer_append_str(buffer,"7E9100E430613361340\r7E8100E430613361340\r7E92113380087133713\r7E82113380087133713\r7E82239AAAAAAAAAAAA\r7E82239AAAAAAAAAAAA\r");
        elm327->recv_buffer = buffer;
        assert(elm327_iso15765_parse_response(elm327,tmp->vehicle));
        vehicle_dump(tmp->vehicle);
        assert(tmp->vehicle->ecus_len == 2);
    ...
    }
    {
        ...
        ELM327Device* elm327 = (ELM327Device*)tmp->device;
        Buffer * buffer = ad_buffer_new();
        ad_buffer_append_str(buffer,"416B1043010300000000\r416B1143010300000000\r");
        elm327->recv_buffer = buffer;
    ...
    }
    {
        ...
        ad_buffer_append_str(buffer,"48 6B 10 43 01 03 01 04 01 05\r48 6B 10 43 01 06 01 07 01 08\r>");
        elm327->recv_buffer = buffer;
        assert(elm_standard_obd_message_parse_response((ELMDevice*)elm327,tmp->vehicle));
        vehicle_dump(tmp->vehicle);
